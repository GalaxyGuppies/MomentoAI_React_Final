...
const UnlockModal: React.FC<UnlockModalProps> = ({ visible, password, onPasswordChange, onConfirm, onCancel }) => (
  <Modal
    visible={visible}
    transparent
    animationType="fade"
  ...
  >
    <View style={{ flex: 1, backgroundColor: 'rgba(0,0,0,0.3)', justifyContent: 'center', alignItems: 'center' }}>
      <View style={{ backgroundColor: '#fff', borderRadius: 16, padding: 24, width: 300, alignItems: 'center' }}>
        <Text style={{ fontSize: 18, fontWeight: 'bold', marginBottom: 12 }}>Unlock Folder</Text>
        <TextInput
          value={password}
